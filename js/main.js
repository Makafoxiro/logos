...
function goPage(name,btn){
  ...
  const active=nav&&nav.querySelector('.nb.on');
  if(active&&nav){
...
// Circular nav scroll: when reaching end, wrap to beginning (and vice versa)
